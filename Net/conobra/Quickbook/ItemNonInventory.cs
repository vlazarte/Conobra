...
namespace Quickbook
{
    public class ItemNonInventory : ItemAbstract
    {
        ...
        public ItemNonInventory ParentRef;
        public int Sublevel;
        ...
        // Is SalesOrPurchase or SalesAndPurchase
        ...
        public bool LoadByListID(string lid, ref string err)
        {
            ...
            if (qbook.Connect())
            {
                ...
                code = res["QBXML"]["QBXMLMsgsRs"]["ItemNonInventoryQueryRs"].Attributes["statusCode"].Value;
                statusMessage = res["QBXML"]["QBXMLMsgsRs"]["ItemNonInventoryQueryRs"].Attributes["statusMessage"].Value;

                if (code == "0")
                {
                    var node = res["QBXML"]["QBXMLMsgsRs"]["ItemNonInventoryQueryRs"]["ItemNonInventoryRet"];
                    ...
                    {
                        ParentRef = new ItemNonInventory();
                    ...
                    {
                        InventoryType = "SalesAndPurchase";
